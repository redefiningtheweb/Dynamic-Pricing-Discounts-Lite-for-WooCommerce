...
class Rtwwdpdl_Woo_Dynamic_Pricing_Discounts_Lite_Admin {
	...
	{
		add_submenu_page( 'woocommerce', esc_attr__( 'Woocommerce Dynamic Pricing & Discounts Lite', 'rtwwdpdl-woo-dynamic-pricing-discounts-lite' ), esc_html__( 'Woocommerce Dynamic Pricing & Discounts Lite', 'rtwwdpdl-woo-dynamic-pricing-discounts-lite' ), 'manage_woocommerce', 'rtwwdpdl', array( $this, 'rtwwdpdl_admin_setting' ) );
	}
