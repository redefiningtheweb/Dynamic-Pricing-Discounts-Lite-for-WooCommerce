 ...
 */
define( 'Rtwwdpdl_Woo_Dynamic_Pricing_Discounts_Lite_VERSION', '1.3.0' );
...
{
	if( in_array('woo-dynamic-pricing-discounts-with-ai/rtwwdpd-woo-dynamic-pricing-discounts-with-ai.php', apply_filters('active_plugins', get_option('active_plugins') ) ) )
	{
		return;
	}
	//Plugin Constant
